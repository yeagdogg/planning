...
# D99 removed zoom_axis()/axis_window(). Charts are back on Excel's automatic
# axis, which starts a value axis at zero. That is genuinely worse for a
# loss-ratio waterfall — the argument in D91 was not wrong — but the baked
# alternative read worse in practice, and a bound that cannot follow a paste is
# a maintenance cost the reader inherits. John adjusts the two or three charts
# he presents from. Nothing here should re-introduce a static axis bound.
