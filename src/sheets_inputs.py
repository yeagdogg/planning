...
def build_control(ctx: Ctx):
    ...
    for i, sheet in enumerate(["Inputs", "Rate Log", "Portfolio", "State Summary", "Bridge",
                               "Walkthrough", "One-Pager", "Flow Dashboard", "Scenarios",
                               "Compare", "Solver", "Attribution", "Rate Engine",
                               "Mod Engine", "Checks", "Methodology", "Read Me"]):
